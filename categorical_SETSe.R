...
#' 
#' Experimental Performs SETSe on every level of a categorical variable. This function is experimental
#' 
#' @param g An igraph object of the network
#' @param force_var A character string of the name of the force variable
#' @param node_names A character string of the variable of the node names
#' @param k A character string of the variable for the spring constant
#' 
#' @export
#' 
