...
#' @param flow a character string. The name of the edge attribute that is used as flow
#' @param capacity a character string. The ame of the edge attribute for edge capacity
#' @param minimum_value a numeric value. Indicating the most stretchy value of young's modulus
